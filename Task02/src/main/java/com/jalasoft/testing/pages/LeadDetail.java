...
public class LeadDetail extends AbstractBasePage {
    ...
    public void campaignExist(String campaignName) {
        wait.until(ExpectedConditions.visibilityOf(leadDescription));
        WebElement campaignFound = driver.findElement(By.xpath("//a[contains(.,campaignName)]"));
    }
